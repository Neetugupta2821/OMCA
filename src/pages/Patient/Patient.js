...
export default function Patient() {
  ...
  const getReportData = () => {
    ...
    axios
      .get(
        `${baseurl}exportfilteredpatient/${localStorage.getItem("_id")}?gender=${encodeURIComponent(report.gender.trim())}&treatment_name=${encodeURIComponent(selectedJobTitle.trim())}&age=${encodeURIComponent(report.age.trim())}&country=${encodeURIComponent(report.country.trim())}`,
        {
        ...
        <div className="content">
          <div className="row">
            <div className="col-md-12">
              <h4 className="page-title">Manage Patients</h4>
            </div>
          </div>
                          ...
                          .map((info, i) => {
                            ...
                            return (
                              ...
                              >
                                ...
                                <TableCell><i className="fa fa-pencil m-r-5" onClick={(e) => EditButton(e, info.patientId)}></i><i className="fa fa-trash-o m-r-5" onClick={(e) => handledelet(e, info.patientId)}></i><VisibilityIcon style={{ "fontSize": "18px" }} onClick={(e) => PatientDetail(e, info.patientId, info.enquiryId)} /></TableCell>
                              </TableRow>
                            );
                          })}
                      </TableBody>
